...
/**
 * Wraps an Enumeration in an Iterable.
 */
public class EnumerationIterable<T> implements Iterable<T>
{
	...
	{
		wrappedEnumeration = enumeration;
	}
	...
	{
		return new EnumerationIterator<T>(wrappedEnumeration);
	}
	
	private static class EnumerationIterator<T> extends ImmutableIterator<T>
	{
		private final Enumeration<T> wrappedEnumeration;
